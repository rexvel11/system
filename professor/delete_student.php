...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($stmt = mysqli_prepare($conn, $deleteQuery)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            echo "<script>alert('Student successfully deleted.'); window.location.href = '/system/professor/prof.php';</script>";
        } else {
            echo "<script>alert('Error deleting student. Please try again later.'); window.location.href = '/system/professor/prof.php';</script>";
        }
    ...
    echo "<script>alert('Invalid student ID.'); window.location.href = '/system/professor/prof.php';</script>";
}
?>
